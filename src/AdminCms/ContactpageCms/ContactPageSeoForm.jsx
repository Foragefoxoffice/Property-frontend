...
export default function ContactPageSeoForm({
    ...
    useEffect(() => {
        if (pageData?.contactSeoOgImages) {
            setOgImages(pageData.contactSeoOgImages);
        }
    }, [pageData]);
    ...
    const handleOgImageUpload = async (file) => {
        try {
            const res = await uploadContactPageImage(file);
            if (res.data.success) {
                ...
                form.setFieldsValue({ contactSeoOgImages: newImages });
    ...
    const handleFormSubmit = (values) => {
        onSubmit({ ...values, contactSeoOgImages: ogImages });
    };
                    ...
                    <ConfigProvider theme={{ token: { colorPrimary: '#41398B' } }}>
                        ...
                        >
                                        ...
                                        children: (
                                            <>
                                                ...
                                                <Form.Item
                                                    ...
                                                    name="contactSeoCanonicalUrl_vn"
                                                >
                                                    <Input
                            ...
                            <Form.Item
                                ...
                                name="contactSeoAllowIndexing"
                                valuePropName="checked"
                                initialValue={true}
                            >
                                <Switch disabled={!can('cms.contactUs', 'edit')} />
                            </Form.Item>
