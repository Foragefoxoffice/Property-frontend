...
export default function ContactPageSeoForm({
    ...
    useEffect(() => {
        if (pageData) {
            setSeo({
                metaTitle: { en: pageData.contactSeoMetaTitle_en || "", vn: pageData.contactSeoMetaTitle_vn || "" },
                metaDescription: { en: pageData.contactSeoMetaDescription_en || "", vn: pageData.contactSeoMetaDescription_vn || "" },
                metaKeywords: { en: pageData.contactSeoMetaKeywords_en || [], vn: pageData.contactSeoMetaKeywords_vn || [] },
                slugUrl: { en: pageData.contactSeoSlugUrl_en || "", vn: pageData.contactSeoSlugUrl_vn || "" },
                canonicalUrl: { en: pageData.contactSeoCanonicalUrl_en || "", vn: pageData.contactSeoCanonicalUrl_vn || "" },
                schemaType: { en: pageData.contactSeoSchemaType_en || "", vn: pageData.contactSeoSchemaType_vn || "" },
                ogTitle: { en: pageData.contactSeoOgTitle_en || "", vn: pageData.contactSeoOgTitle_vn || "" },
                ogDescription: { en: pageData.contactSeoOgDescription_en || "", vn: pageData.contactSeoOgDescription_vn || "" },
                allowIndexing: pageData.contactSeoAllowIndexing !== false,
                ogImage: pageData.contactSeoOgImage || (pageData.contactSeoOgImages && pageData.contactSeoOgImages[0]) || "",
            });
        }
    }, [pageData]);
    ...
    useEffect(() => {
        if (!pageData) {
            setSeo(prev => ({
                ...prev,
                metaTitle: {
                    en: prev.metaTitle.en || 'Contact Us | 183 Housing Solutions',
                    vn: prev.metaTitle.vn || 'Liên Hệ | 183 Housing Solutions'
                },
                slugUrl: {
                    en: prev.slugUrl.en || 'contact',
                    vn: prev.slugUrl.vn || 'lien-he'
                }
            }));
        }
    }, [pageData]);
    ...
    const handleAutoGenerate = (field) => {
        const content = buildCmsContent(activeLang, 'contact');
        const fieldMap = {
    ...
    const handleComplete = () => {
        const payload = {
            contactSeoMetaTitle_en: seo.metaTitle.en,
            contactSeoMetaTitle_vn: seo.metaTitle.vn,
            contactSeoMetaDescription_en: seo.metaDescription.en,
            contactSeoMetaDescription_vn: seo.metaDescription.vn,
            contactSeoMetaKeywords_en: seo.metaKeywords.en,
            contactSeoMetaKeywords_vn: seo.metaKeywords.vn,
            contactSeoSlugUrl_en: seo.slugUrl.en,
            contactSeoSlugUrl_vn: seo.slugUrl.vn,
            // Compute Canonical dynamically if empty
            contactSeoCanonicalUrl_en: seo.canonicalUrl.en || `https://183housingsolutions.com${seo.slugUrl.en !== '/' ? (seo.slugUrl.en.startsWith('/') ? seo.slugUrl.en : '/' + seo.slugUrl.en) : ''}`,
            contactSeoCanonicalUrl_vn: seo.canonicalUrl.vn || `https://183housingsolutions.com${seo.slugUrl.vn !== '/' ? (seo.slugUrl.vn.startsWith('/') ? seo.slugUrl.vn : '/' + seo.slugUrl.vn) : ''}`,
            contactSeoSchemaType_en: seo.schemaType.en,
            contactSeoSchemaType_vn: seo.schemaType.vn,
            contactSeoAllowIndexing: seo.allowIndexing,
            contactSeoOgTitle_en: seo.ogTitle.en,
            contactSeoOgTitle_vn: seo.ogTitle.vn,
            contactSeoOgDescription_en: seo.ogDescription.en,
            contactSeoOgDescription_vn: seo.ogDescription.vn,
            contactSeoOgImage: seo.ogImage
        };
        onSubmit(payload);
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 font-['Manrope']">
                            {headerLang === 'en' ? 'Manage contact page SEO and meta information' : 'Quản lý SEO trang liên hệ và thông tin meta'}
                        </p>
                    </div>
                </div>
