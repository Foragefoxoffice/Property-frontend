...
export default function HomePageForm() {
    ...
    const handleBannerSubmit = async (values) => {
        try {
            ...
            if (pageData) {
                ...
                message.success('Banner section updated successfully!');
            } else {
                ...
                message.success('Home page created successfully!');
            }

            fetchPageData();
        } catch (error) {
            if (error.errorFields) {
                message.error('Please fill in the About Us section first');
            } else {
                message.error(error.response?.data?.message || 'Failed to save banner section');
                console.error(error);
            }
        } finally {
    ...
    const handleAboutSubmit = async (values) => {
        try {
            ...
            if (error.errorFields) {
                message.error('Please fill in the Banner section first');
            } else {
                message.error(error.response?.data?.message || 'Failed to save about section');
                console.error(error);
            }
        } finally {
