...
export default function TermsCondionsSeoForm({
    ...
    useEffect(() => {
        if (pageData) {
            setSeo({
                metaTitle: { en: pageData.termsConditionSeoMetaTitle_en || pageData.termsconditionsSeoMetaTitle_en || "", vn: pageData.termsConditionSeoMetaTitle_vn || pageData.termsconditionsSeoMetaTitle_vn || "" },
                metaDescription: { en: pageData.termsConditionSeoMetaDescription_en || pageData.termsconditionsSeoMetaDescription_en || "", vn: pageData.termsConditionSeoMetaDescription_vn || pageData.termsconditionsSeoMetaDescription_vn || "" },
                metaKeywords: { en: pageData.termsConditionSeoMetaKeywords_en || pageData.termsconditionsSeoMetaKeywords_en || [], vn: pageData.termsConditionSeoMetaKeywords_vn || pageData.termsconditionsSeoMetaKeywords_vn || [] },
                slugUrl: { en: pageData.termsConditionSeoSlugUrl_en || pageData.termsconditionsSeoSlugUrl_en || "", vn: pageData.termsConditionSeoSlugUrl_vn || pageData.termsconditionsSeoSlugUrl_vn || "" },
                canonicalUrl: { en: pageData.termsConditionSeoCanonicalUrl_en || "", vn: pageData.termsConditionSeoCanonicalUrl_vn || "" },
                schemaType: { en: pageData.termsConditionSeoSchemaType_en || "", vn: pageData.termsConditionSeoSchemaType_vn || "" },
                ogTitle: { en: pageData.termsConditionSeoOgTitle_en || "", vn: pageData.termsConditionSeoOgTitle_vn || "" },
                ogDescription: { en: pageData.termsConditionSeoOgDescription_en || "", vn: pageData.termsConditionSeoOgDescription_vn || "" },
                allowIndexing: pageData.termsConditionSeoAllowIndexing !== false,
                ogImage: pageData.termsConditionSeoOgImage || (pageData.termsConditionSeoOgImages && pageData.termsConditionSeoOgImages[0]) || "",
            });
        }
    }, [pageData]);
    ...
    useEffect(() => {
        if (!pageData) {
            setSeo(prev => ({
                ...prev,
                metaTitle: {
                    en: prev.metaTitle.en || 'Terms and Conditions',
                    vn: prev.metaTitle.vn || 'Điều Khoản Điều Kiện'
                },
                slugUrl: {
                    en: prev.slugUrl.en || 'terms-and-conditions',
                    vn: prev.slugUrl.vn || 'dieu-khoan-dieu-kien'
                }
            }));
        }
    }, [pageData]);
    ...
    const handleAutoGenerate = (field) => {
        const content = buildCmsContent(activeLang, 'terms');
        const fieldMap = {
    ...
    const handleComplete = () => {
        const payload = {
            termsConditionSeoMetaTitle_en: seo.metaTitle.en,
            termsConditionSeoMetaTitle_vn: seo.metaTitle.vn,
            termsConditionSeoMetaDescription_en: seo.metaDescription.en,
            termsConditionSeoMetaDescription_vn: seo.metaDescription.vn,
            termsConditionSeoMetaKeywords_en: seo.metaKeywords.en,
            termsConditionSeoMetaKeywords_vn: seo.metaKeywords.vn,
            termsConditionSeoSlugUrl_en: seo.slugUrl.en,
            termsConditionSeoSlugUrl_vn: seo.slugUrl.vn,
            // Compute Canonical dynamically if empty
            termsConditionSeoCanonicalUrl_en: seo.canonicalUrl.en || `https://183housingsolutions.com${seo.slugUrl.en !== '/' ? (seo.slugUrl.en.startsWith('/') ? seo.slugUrl.en : '/' + seo.slugUrl.en) : ''}`,
            termsConditionSeoCanonicalUrl_vn: seo.canonicalUrl.vn || `https://183housingsolutions.com${seo.slugUrl.vn !== '/' ? (seo.slugUrl.vn.startsWith('/') ? seo.slugUrl.vn : '/' + seo.slugUrl.vn) : ''}`,
            termsConditionSeoSchemaType_en: seo.schemaType.en,
            termsConditionSeoSchemaType_vn: seo.schemaType.vn,
            termsConditionSeoAllowIndexing: seo.allowIndexing,
            termsConditionSeoOgTitle_en: seo.ogTitle.en,
            termsConditionSeoOgTitle_vn: seo.ogTitle.vn,
            termsConditionSeoOgDescription_en: seo.ogDescription.en,
            termsConditionSeoOgDescription_vn: seo.ogDescription.vn,
            termsConditionSeoOgImage: seo.ogImage
        };
        onSubmit(payload);
    };
