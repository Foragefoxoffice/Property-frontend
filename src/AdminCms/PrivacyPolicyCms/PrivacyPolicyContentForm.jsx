                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 font-['Manrope']">
                            {headerLang === 'en' ? 'Privacy Policy Content' : 'Nội Dung Chính Sách Bảo Mật'}
                        </h3>
                        <p className="text-sm text-gray-500 font-['Manrope']">
                            {headerLang === 'en' ? 'Manage the main content of the Privacy Policy page' : 'Quản lý nội dung chính của trang chính sách bảo mật'}
                        </p>
                    </div>
                </div>
                    ...
                    <ConfigProvider theme={{ token: { colorPrimary: '#41398B' } }}>
                        <Form
                            ...
                            onFinish={(values) => {
                                ...
                                if (values.privacyPolicyContent_vn) {
                                    values.privacyPolicyContent_vn = sanitizeBeforeSave(values.privacyPolicyContent_vn);
                                }
                                if (values.privacyPolicyContent_en) {
                                    values.privacyPolicyContent_en = sanitizeBeforeSave(values.privacyPolicyContent_en);
                                }
                                onSubmit(values);
                            }}
                                        ...
                                        children: (
                                            <div className="space-y-4">
                                                <Form.Item
                                                    ...
                                                    name="privacyPolicyContentTitle_en"
                                                    rules={[
