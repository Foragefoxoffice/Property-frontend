...
export default function PrivacyPolicyBannerForm({
    form,
    onSubmit,
    loading,
    pageData,
    ...
    useEffect(() => {
        if (pageData?.privacyPolicyBannerImage) {
            setBannerImageUrl(pageData.privacyPolicyBannerImage);
        }
    }, [pageData]);
    ...
    const handleImageUpload = async (file) => {
        try {
            ...
            form.setFieldsValue({ privacyPolicyBannerImage: uploadedUrl });
    ...
    const removeBannerImage = () => {
        setBannerImageUrl('');
        form.setFieldsValue({ privacyPolicyBannerImage: '' });
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 font-['Manrope']">
                            {headerLang === 'en' ? 'Privacy Policy Banner' : 'Banner Chính Sách Bảo Mật'}
                        </h3>
                        <p className="text-sm text-gray-500 font-['Manrope']">
                            {headerLang === 'en' ? 'Manage the banner for the Privacy Policy page' : 'Quản lý banner cho trang chính sách bảo mật'}
                        </p>
                    </div>
                </div>
                                        ...
                                        children: (
                                            <>
                                                <Form.Item
                                                    ...
                                                    name="privacyPolicyBannerTitle_en"
                                                    rules={[
