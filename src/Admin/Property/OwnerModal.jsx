...
const uiText = {
    EN: {
        ...
        placeholderOwnerName: "Type Owner Name",
        gender: "Gender",
        phone: "Phone Number",
...
export default function OwnerModal({ onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            CommonToaster("New Owner created successfully", "success");
            onClose();
        } catch {
            CommonToaster("Failed to create owner", "error");
        }
    };
                        ...
                        {socialMedia.map((row, idx) => (
                            <div key={idx} className="flex items-center gap-3 mt-3">
                                ...
                                <input
                                    ...
                                    value={
                                        activeLang === "EN" ? row.link_en : row.link_vi
                                    }
                                    onChange={(e) =>
                                        updateSocialRow(
                                            idx,
