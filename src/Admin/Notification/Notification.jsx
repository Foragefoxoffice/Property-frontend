                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end">
                            <button
                                type="submit"
                                disabled={saving}
                                className={`flex items-center gap-2 px-6 py-2.5 bg-[#41398B] hover:bg-[#352e72] text-white rounded-full font-medium transition shadow-md ${saving ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
                                {saving ? (
