        ...
        <div className="flex flex-col">
            ...
            >
                {options.map((opt) => {
                    ...
                    return (
                        <Option key={opt._id || opt.id} value={opt._id || opt.id} label={label}>
                            {label}
                        </Option>
                    );
                })}
    ...
    return (
        <div className="min-h-screen bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
            ...
            <div className="grid grid-cols-3 gap-7">
                <Select label={t[lang].project} name="projectId" value={filters.projectId} onChange={update} options={projects} lang={lang} />
                <Select label={t[lang].zone} name="zoneId" value={filters.zoneId} onChange={update} options={zones} lang={lang} />
                <Select label={t[lang].block} name="blockId" value={filters.blockId} onChange={update} options={blocks} lang={lang} />

                <Select label={t[lang].propertyType} name="propertyType" value={filters.propertyType} onChange={update} options={propertyTypes} lang={lang} />

                <Input label={t[lang].propertyNumber} name="propertyNumber" value={filters.propertyNumber} onChange={update} placeholder="Type here" />

                <Select label={t[lang].floorRange} name="floorRange" value={filters.floorRange} onChange={update} options={floorRanges} lang={lang} />
            </div>
            ...
            <div className="grid grid-cols-3 gap-7">
                <Select label={t[lang].currency} name="currency" value={filters.currency} onChange={update} options={currencies} lang={lang} />

                <Input label={t[lang].from} name="priceFrom" value={filters.priceFrom} onChange={update} placeholder="Type here" />
                <Input label={t[lang].to} name="priceTo" value={filters.priceTo} onChange={update} placeholder="Type here" />
            </div>
