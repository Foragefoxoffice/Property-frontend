        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleChange("slugUrl", activeLang, e.target.value)
                    }
                />
            </div>
            ...
            <div>
                <h2 className="text-black text-lg font-semibold">{labels.social[activeLang]}</h2>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleChange("ogTitle", activeLang, e.target.value)
                    }
                />
            </div>
            ...
            <div>
              ...
              transition-all flex justify-center items-center gap-3 opacity-0 group-hover:opacity-100">
                    ...
                    {/* ✅ UPLOAD BOX */}
                    <label className="w-70 h-60 border border-dashed border-[#646466] rounded-xl 
            flex flex-col items-center justify-center cursor-pointer bg-white hover:bg-gray-50">
                        ...
                        <span className="text-xs mt-2 text-[#646466]">{labels.upload[activeLang]}</span>
