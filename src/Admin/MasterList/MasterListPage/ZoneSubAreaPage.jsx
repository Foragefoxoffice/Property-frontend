        ...
        <div className="p-8 min-h-screen bg-gradient-to-b from-white to-[#f3f2ff] relative">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900">Zone / Sub-area</h2>
                </div>
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl shadow-lg w-full max-w-sm p-6">
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                            Are you sure you want to delete this Zone/Sub-area? This action cannot
                            be undone.
                        </p>
                            ...
                            {activeLang === "EN" ? (
                                <>
                                    ...
                                    <input
                                        type="text"
                                        name="name_en"
                                        placeholder="Zone / Sub-area (English)"
                                        value={form.name_en}
                                        onChange={handleChange}
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black"
                                    />
                                ...
                                <>
                                    ...
                                    <input
                                        type="text"
                                        name="name_vi"
                                        placeholder="Khu vực / Tiểu khu (Vietnamese)"
                                        value={form.name_vi}
                                        onChange={handleChange}
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black"
                                    />
