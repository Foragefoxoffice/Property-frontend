...
export default function PropertyPage({ goBack }) {
    ...
    const [tableLang, setTableLang] = useState("EN"); // ✅ Language switch for table
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <span
                                className={`transition-all duration-300 px-2 py-1 rounded-full ${tableLang === "EN"
                                    ? "bg-black text-white"
                                    : "text-gray-600"
                                    }`}
                            >
                            ...
                            <span
                                className={`transition-all duration-300 px-2 py-1 rounded-full ${tableLang === "VI"
                                    ? "bg-black text-white"
                                    : "text-gray-600"
                                    }`}
                            >
                            ...
                            {activeLang === "EN" ? (
                                <>
                                    ...
                                    <input
                                        type="text"
                                        name="name_en"
                                        placeholder="Project / Community (English)"
                                        value={form.name_en}
                                        onChange={handleChange}
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black"
                                    />
                                ...
                                <>
                                    ...
                                    <input
                                        type="text"
                                        name="name_vi"
                                        placeholder="Dự án / Khu cộng đồng (Vietnamese)"
                                        value={form.name_vi}
                                        onChange={handleChange}
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black"
                                    />
