                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-12 mb-8 border-b border-gray-800 pb-12">
                    ...
                    <div className="lg:col-span-3 lg:col-start-10 pt-2">
                        ...
                        <div className="flex gap-6">
                            ...
                            <Link to="/privacy-policy" className="text-[#898989] hover:text-white text-[14px] underline underline-offset-4 decoration-gray-600 hover:decoration-white transition-all">
                                {st('privacyPolicy')}
                            </Link>
                        </div>
                    </div>
