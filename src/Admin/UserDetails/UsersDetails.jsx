                    ...
                    <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className={`px-5 py-2.5 bg-red-600 text-white rounded-full hover:bg-red-700 font-medium text-sm shadow-sm transition flex items-center gap-2 ${deleteLoading ? "opacity-70 cursor-not-allowed" : ""}`}
                            >
                                {deleteLoading && (
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
                        ...
                        <div className="flex justify-end items-center gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
                            ...
                            <button
                                ...
                                className={`px-6 py-2.5 cursor-pointer rounded-full bg-[#41398B] hover:bg-[#41398b] text-white font-medium text-sm shadow-md transition transform active:scale-95 flex items-center gap-2 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
                            >
                                {isSubmitting && (
                                    <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                                )}
