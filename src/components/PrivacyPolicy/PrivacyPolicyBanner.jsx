...
export default function PrivacyPolicyBanner({ data }) {
    ...
    const title = language === 'en'
        ? (data?.privacyPolicyBannerTitle_en || 'Privacy Policy')
        : (data?.privacyPolicyBannerTitle_vn || 'Chính Sách Bảo Mật');

    const bgImage = data?.privacyPolicyBannerImage ? getImageUrl(data.privacyPolicyBannerImage) : null;
