                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="grid grid-cols-12 gap-4 border-b border-gray-100 bg-gray-50/50 px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            ...
                            <div className="col-span-6 md:col-span-3 text-center hidden md:block">Date Published</div>
                        ...
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-16 px-4">
                                ...
                                <p className="text-gray-500 mt-1 mb-6 text-center max-w-sm">
                                    Start exploring and save properties you love to your favorites list.
                                </p>
                                <Link
                                    to="/listing"
                                            ...
                                            <div className="col-span-12 md:col-span-6 flex gap-5">
                                                ...
                                                <div className="flex flex-col justify-center gap-1">
                                                    <h3 className="font-bold text-gray-900 text-base line-clamp-1">
                                                        <Link to={`/property-showcase/${prop.listingInformation?.listingInformationPropertyId || prop._id}`} className="hover:text-[#41398B] transition-colors">
                                                    ...
                                                    <div className="flex items-center gap-1 text-xs text-gray-500">
                                                        ...
                                                        <span className="line-clamp-1">
                                                            {getLocalizedValue(prop.listingInformation?.listingInformationProjectCommunity) ||
                                                                getLocalizedValue(prop.listingInformation?.listingInformationZoneSubArea) || 'Location N/A'}
                                                        </span>
                                                    </div>
                                                    <p className="text-xs text-gray-500 mt-0.5">
                                                        Posting date: <span className="text-gray-700 font-medium">{formatDate(prop.listingInformation?.listingInformationDateListed || prop.createdAt)}</span>
                                                    </p>
