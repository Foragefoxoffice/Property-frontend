    ...
    return (
        <>
            ...
            <div className="flex h-[calc(100vh-80px)] bg-gradient-to-b from-[#F7F6F9] to-[#EAE8FD] pt-4 pb-16 lg:pb-0 relative">
                ...
                <div className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-100 flex items-center justify-around px-2 z-[100] lg:hidden shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
                    <button
                        onClick={() => navigate("/user-dashboard")}
