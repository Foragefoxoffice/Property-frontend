...
// Root layout: renders global UI that needs router context + all page routes
const RootLayout = () => (
  <>
    <ScrollToTop />
    <ScrollUpButton />
  ...
  createRoutesFromElements(
    <Route element={<RootLayout />}>
      ...
      >
        ...
        <Route path="lease/edit/:id" element={<CreatePropertyPage isEditMode defaultTransactionType="Lease" />} />
        <Route path="sale/edit/:id" element={<CreatePropertyPage isEditMode defaultTransactionType="Sale" />} />
        <Route path="homestay/edit/:id" element={<CreatePropertyPage isEditMode defaultTransactionType="Home Stay" />} />

        {/* BULK UPLOAD ROUTES */}
        <Route path=":type/bulk-upload" element={<BulkUpload />} />
